...
public class ConstantesUtil {
    ...
    public static final String MENSAGEM_ESCREVER_CATEGORIA = "Escreva a categoria da sua habilidade";
    public static final String MENSAGEM_ESCREVER_HABILIDADE = "Escreva a sua habilidade";
